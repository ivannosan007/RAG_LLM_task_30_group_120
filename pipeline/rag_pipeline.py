...
class RAGPipeline:
    ...
    def _initialize_ollama(self):
        ...
        logger.info(f"Using Ollama backend with model: {self.ollama_model}")
    ...
    def query(
        ...
        user_prompt = self.generate_prompt(question, retrieved)
        messages = [
            {
                "role": "system",
        ...
        return answer.strip(), user_prompt, retrieved
