...
def main():
    ...
    questions, ground_truth_answers, contexts, filenames = load_test_dataset(config, sample_size=sample_size)
    ...
    if os.environ.get("SKIP_BERTSCORE"):
        bert_score_value = 0.0
        logger.warning("Skipping BERTScore (SKIP_BERTSCORE is set)")
    else:
